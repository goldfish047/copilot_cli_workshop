...
```text
I like the disney universe of cartoon characters and would like to assign a squad to work on the Chinook.Web project. <br /> Review the current state, propose. new features, and discuss next steps. 
```
